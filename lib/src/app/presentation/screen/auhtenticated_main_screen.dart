...
@RoutePage()
class AuhtenticatedMainScreen extends StatefulWidget {
  const AuhtenticatedMainScreen({super.key});

  @override
  State<AuhtenticatedMainScreen> createState() =>
      _AuhtenticatedMainScreenState();
}

class _AuhtenticatedMainScreenState extends State<AuhtenticatedMainScreen> {
  @override
  void initState() {
    super.initState();
