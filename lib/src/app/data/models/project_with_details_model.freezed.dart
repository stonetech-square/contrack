...
@useResult
$Res call({
 String code, ProjectStatus status, int agencyId, String agencyName, int ministryId, String ministryName, int stateId, String stateName, int zoneId, String zoneName, String title, double amount, String constituency, String? sponsor, int createdBy, String? createdByName, int? modifiedBy, String? modifiedByName, DateTime createdAt, DateTime updatedAt, bool isSynced, DateTime? lastSyncedAt, String? remoteId
});
...
as int?,modifiedByName: freezed == modifiedByName ? _self.modifiedByName : modifiedByName // ignore: cast_nullable_to_non_nullable
...
class _ProjectWithDetailsModel extends ProjectWithDetailsModel {
  const _ProjectWithDetailsModel({required this.code, required this.status, required this.agencyId, required this.agencyName, required this.ministryId, required this.ministryName, required this.stateId, required this.stateName, required this.zoneId, required this.zoneName, required this.title, required this.amount, required this.constituency, this.sponsor, required this.createdBy, this.createdByName, this.modifiedBy, this.modifiedByName, required this.createdAt, required this.updatedAt, this.isSynced = false, this.lastSyncedAt, this.remoteId}): super._();
