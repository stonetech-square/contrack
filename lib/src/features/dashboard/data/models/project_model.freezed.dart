...
@useResult
$Res call({
 int id, String code, ProjectStatus status, int agencyId, int ministryId, int stateId, int zoneId, String title, double amount, String constituency, String? sponsor, int createdBy, int? modifiedBy, DateTime createdAt, DateTime updatedAt, bool isSynced, DateTime? lastSyncedAt, String? remoteId
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int id,  String code,  ProjectStatus status,  int agencyId,  int ministryId,  int stateId,  int zoneId,  String title,  double amount,  String constituency,  String? sponsor,  int createdBy,  int? modifiedBy,  DateTime createdAt,  DateTime updatedAt,  bool isSynced,  DateTime? lastSyncedAt,  String? remoteId)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ProjectModel() when $default != null:
return $default(_that.id,_that.code,_that.status,_that.agencyId,_that.ministryId,_that.stateId,_that.zoneId,_that.title,_that.amount,_that.constituency,_that.sponsor,_that.createdBy,_that.modifiedBy,_that.createdAt,_that.updatedAt,_that.isSynced,_that.lastSyncedAt,_that.remoteId);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int id,  String code,  ProjectStatus status,  int agencyId,  int ministryId,  int stateId,  int zoneId,  String title,  double amount,  String constituency,  String? sponsor,  int createdBy,  int? modifiedBy,  DateTime createdAt,  DateTime updatedAt,  bool isSynced,  DateTime? lastSyncedAt,  String? remoteId)  $default,) {final _that = this;
switch (_that) {
case _ProjectModel():
return $default(_that.id,_that.code,_that.status,_that.agencyId,_that.ministryId,_that.stateId,_that.zoneId,_that.title,_that.amount,_that.constituency,_that.sponsor,_that.createdBy,_that.modifiedBy,_that.createdAt,_that.updatedAt,_that.isSynced,_that.lastSyncedAt,_that.remoteId);}
}
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int id,  String code,  ProjectStatus status,  int agencyId,  int ministryId,  int stateId,  int zoneId,  String title,  double amount,  String constituency,  String? sponsor,  int createdBy,  int? modifiedBy,  DateTime createdAt,  DateTime updatedAt,  bool isSynced,  DateTime? lastSyncedAt,  String? remoteId)?  $default,) {final _that = this;
switch (_that) {
case _ProjectModel() when $default != null:
return $default(_that.id,_that.code,_that.status,_that.agencyId,_that.ministryId,_that.stateId,_that.zoneId,_that.title,_that.amount,_that.constituency,_that.sponsor,_that.createdBy,_that.modifiedBy,_that.createdAt,_that.updatedAt,_that.isSynced,_that.lastSyncedAt,_that.remoteId);case _:
  return null;
...
class _ProjectModel extends ProjectModel {
  const _ProjectModel({required this.id, required this.code, required this.status, required this.agencyId, required this.ministryId, required this.stateId, required this.zoneId, required this.title, required this.amount, required this.constituency, this.sponsor, required this.createdBy, this.modifiedBy, required this.createdAt, required this.updatedAt, this.isSynced = false, this.lastSyncedAt, this.remoteId}): super._();
